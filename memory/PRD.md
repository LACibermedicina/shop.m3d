...
## Import Log — 2026-09-04
- Importado do GitHub: https://github.com/LACibermedicina/shop.m3d (versão catalogo).
- Copiados backend/, frontend/, memory/, docs para /app preservando .env, .git, .emergent.
- Dependências instaladas (pip backend incl. emergentintegrations + reportlab; yarn frontend).
