        ...
        {waLog.length === 0 ? (
          ...
          waLog.slice(0, 60).map((w, i) => {
            const map: any = {
              ...
              abrir_loja: ["storefront-outline", colors.success],
              fechar_loja: ["moon-outline", colors.onSurfaceTertiary],
              ver_pedidos: ["receipt-outline", colors.info],
              criar_cupom: ["pricetag-outline", colors.warning],
              buscar: ["search-outline", colors.brandSecondary],
              adicionar: ["cart-outline", colors.success],
              remover: ["remove-circle-outline", colors.error],
              ver_carrinho: ["cart-outline", colors.info],
              finalizar: ["checkmark-done-outline", colors.brandPrimary],
              confirmar: ["checkmark-circle-outline", colors.success],
              cancelar: ["close-circle-outline", colors.error],
              admin: ["shield-checkmark-outline", colors.brandPrimary],
